...
- [x] **10. Citation collection.** Done 2026-07-12 → `docs/references.md` updated. All 6 core DOIs verified live. Locked Ziter et al. 2019 PNAS for canopy cooling coefficients. Santamouris 2014 (Solar Energy, cool-roof coefficient) DOI confirmed `10.1016/j.solener.2012.07.003`, marked verified in `references.md`/`citations.ts` — this item's earlier "needs final confirm" flag is stale, already closed.
